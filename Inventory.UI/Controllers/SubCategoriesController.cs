...
namespace Inventory.Core.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public SubCategoriesController(Inventory_ManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var inventory_ManagementContext = _context.SubCategory.Include(t => t.Category);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tbSubCategory = await _context.SubCategory
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.SubCategory, "CategoryId", "CategoryId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,SubCategoryId,SubCategoryName,SubCategoryDescription,CreatedBy,CreatedOn,ModifiedBy,ModifiedOn,IsActive,IsDeleted")] TbSubCategory tbSubCategory)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.SubCategory, "CategoryId", "CategoryDescription", tbSubCategory.CategoryId);
            return View(tbSubCategory);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tbSubCategory = await _context.SubCategory.FindAsync(id);
            if (tbSubCategory == null)
            {
                return NotFound();
            }
        ...
        {
            var tbSubCategory = await _context.SubCategory.FindAsync(id);
            _context.SubCategory.Remove(tbSubCategory);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
